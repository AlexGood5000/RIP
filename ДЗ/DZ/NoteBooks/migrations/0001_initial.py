    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ram', models.IntegerField(verbose_name='Оперативная паямять')),
                ('os', models.CharField(max_length=50, verbose_name='Операционная система')),
                ('image', models.ImageField(upload_to='', verbose_name='Изображение')),
                ('manuf', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='NoteBooks.manufacturer')),
            ],
        ),
    ]
